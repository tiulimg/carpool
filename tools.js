...
function only_hikes_in_lang(docs, hikelist, lang) {
    var istext = (hikelist && hikelist.length && hikelist.length > 0 && typeof hikelist[0] === "string");
...
function remove_past_hikes(hikelist) {
    var istext = (hikelist && hikelist.length && hikelist.length > 0 && typeof hikelist[0] === "string");
    var today = new Date()
...
function is_past_date(date) {
    var today = new Date()
    var hikedate = datestringtoobject(date);
    return (hikedate && today > hikedate);
}
...
function sort_hikes(docs) {
    var istext = (docs && docs.length && docs.length > 0 && typeof docs[0] === "string");
